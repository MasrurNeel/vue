        ...
        <div class="p-8">
                    ...
                    <div class="container">
                        <div class="flex items-center">
                            <div class="w-1/2 mr-6 font-size-22">
                                ...
                                <h2 class="text-7xl font-bold mb-6 text-gray-800">Bengal Vegetable
                                    farm  Organic 100%</h2>
                            ...
                            <div class="w-1/2 flex justify-end">
                                <img src="~/assets/img/hero.png" alt="" width="550">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container pt-20">
                ...
                <div class="flex items-center mb-10">
                    <div style="height: 3px" class="w-32 bg-dark-green-bg"></div>
                ...
                <vue-slick-carousel class="category-carousel mb-10"  v-bind="CategoryCarouselSettings">
                    <div class="bg-gray-100 p-4 mx-4">
                    ...
                    <div class="bg-gray-100 p-4 mx-4">
                        ...
                        <h4 class="text-xl">Vegetables</h4>
                    </div>
                    ...
                    <div class="bg-gray-100 p-4 mx-4">
                        ...
                        <h4 class="text-xl">Ice Creams</h4>
                    </div>
